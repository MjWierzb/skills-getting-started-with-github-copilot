...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and improve soccer skills in weekly matches",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": []
    },
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and game strategy in a competitive setting",
